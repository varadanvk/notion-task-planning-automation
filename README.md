...
```
git clone https://github.com/varadanvk/notion-task-planning-automation.git
...
- Follow the [Google Calendar API Python Quickstart](https://developers.google.com/calendar/quickstart/python) to:
...
- Add the following variables:
  ...
  CALENDAR_ACCOUNT=your_google_calendar_email
  ```
...
5. Review the generated `calendar_events.json` file to see the planned schedule

6. To automatically add the events to your Google Calendar, uncomment the relevant line in `main.py`
